...
export const horizontalMenuItems = [
  new Menu(1, "Controle Mensal", "/", null, "file-text-o", null, false, 0),

  new Menu(40, "Cadastros", null, null, "window-maximize", null, true, 0),
  new Menu(4001, "Usuários", "/usuarios", null, "users", null, false, 40),
];
